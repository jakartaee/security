...
public class AppHamWorkflowSecureResponseIT extends ArquillianBase {
    ...
    /**
     * Migrated from old-tck ham/workflow/secureresponse#testHAMSecureResponse:
     * the response body should record the call sequence Filter.doFilter ->
     * Servlet.service -> HAM.secureResponse.
     */
    @Test
