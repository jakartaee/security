...
public class AppLdapGroupmemberofIT extends ArquillianBase {
    ...
    /**
     * Migrated from old-tck idstore/ldap/groupmemberof.
     *
     * The {@code groupMemberOfAttribute} is set to {@code seeAlso}: groups for
     * {@code emmax} are taken from the {@code seeAlso} attribute on the user
     * entry. Expect Administratorx + Employeex.
     */
    @Test
