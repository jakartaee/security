...
public class AppLdapInvalidsearchscopeexprIT extends ArquillianBase {
    ...
    /**
     * Migrated from old-tck idstore/ldap/invalidsearchscopeexpr.
     *
     * Both {@code callerSearchScopeExpression} and
     * {@code groupSearchScopeExpression} reference invalid EL bean
     * properties: evaluation must fail and the HAM reports
     * "Exception received."
     */
    @Test
