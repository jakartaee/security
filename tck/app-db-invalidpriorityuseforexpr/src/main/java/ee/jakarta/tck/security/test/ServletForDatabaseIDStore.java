...
/**
 * The {@code priorityExpression} references an undefined variable ({@code ${abc}}).
 * Evaluating that expression must fail; per spec the failure is propagated as
 * an exception when the store is exercised, which the HAM surfaces as
