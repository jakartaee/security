...
/**
 * EL config bean used by the {@code useForExpression} attribute. Note that the
 * {@code priorityExpression} attribute deliberately uses an undefined variable
 * ({@code ${abc}}) to trigger the failure being tested.
 */
@RequestScoped
@Named
