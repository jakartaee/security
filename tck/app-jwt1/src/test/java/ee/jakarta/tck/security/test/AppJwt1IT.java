...
public class AppJwt1IT extends ArquillianBase {
    ...
    public void testAuthenticated() {
    	...
    	getWebClient().addRequestHeader("Authorization", "Bearer " + getJWE());
...
//    }
    ...
    private String getJWE() {
        try {
            return new String(getClass().getClassLoader().getResourceAsStream("token.jws").readAllBytes(), UTF_8);
        } catch (IOException e) {
