...
public class AppLdapInvalidgroupnameattrIT extends ArquillianBase {
    ...
    /**
     * Migrated from old-tck idstore/ldap/invalidgroupnameattr.
     *
     * Wrong {@code groupNameAttribute}: caller authenticates but groups are
     * empty (no readable name for the group entries).
     */
    @Test
