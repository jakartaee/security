...
public class AppDbInvalidDataSourceIT extends ArquillianBase {
    ...
    /**
     * Migrated from old-tck idstore/database/invaliddatasource#testAnnotationDBIDStore_Invaliddatasource.
     *
     * The DatabaseIdentityStore is configured with a non-existent
     * dataSourceLookup. The lookup must fail with an exception that the HAM
