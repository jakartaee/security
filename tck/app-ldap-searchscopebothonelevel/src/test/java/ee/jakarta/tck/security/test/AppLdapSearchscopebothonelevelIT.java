...
public class AppLdapSearchscopebothonelevelIT extends ArquillianBase {
    ...
    /**
     * Migrated from old-tck idstore/ldap/searchscopebothonelevel.
     *
     * Both caller and group searches use ONE_LEVEL.  Top-level user {@code tom}
     * authenticates with Administrator+Manager; nested user {@code subtom} is
     * not visible at one level so authentication fails.
     */
    @Test
