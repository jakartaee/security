...
/**
 * Both {@code priorityExpression} and {@code useForExpression} use bean EL
 * expressions to override the literal {@code priority = 100} and
 * {@code useFor = {VALIDATE}} values. Effective configuration: priority 300,
