...
public class AppLdapSearchscopecalleronelevelgroupsubtreeIT extends ArquillianBase {
    ...
    /**
     * Migrated from old-tck idstore/ldap/searchscopecalleronelevelgroupsubtree.
     *
     * Caller search ONE_LEVEL, group search SUBTREE.  {@code tom} resolves and
     * his groups include both top-level and nested subgroups; {@code subtom}
     * is not visible to the caller search.
     */
    @Test
