...
public class AppDbInvalidGroupsQueryIT extends ArquillianBase {
    ...
    /**
     * Migrated from old-tck idstore/database/invalidgroupsquery#testAnnotationDBIDStore_Invalidgroupsquery.
     *
     * The DatabaseIdentityStore has a groupsQuery referencing a non-existent
     * column. Group resolution must fail with an exception that the HAM
     * surfaces as "Exception received." in the response body.
     */
    @Test
