...
public class AppLdapInvalidurlIT extends ArquillianBase {
    ...
    /**
     * Migrated from old-tck idstore/ldap/invalidurl.
     *
     * URL points to a non-listening port; validation must yield INVALID with
     * no groups (or an exception, depending on how the implementation maps
     * connect failures).
     */
    @Test
