...
public class AppLdapInvalidcallersearchbaseIT extends ArquillianBase {
    ...
    /**
     * Migrated from old-tck idstore/ldap/invalidcallersearchbase.
     *
     * {@code callerSearchBase} points to a non-existent OU; the search throws
     * and the HAM reports the exception (or returns INVALID).
     */
    @Test
