...
public class AppLdapInvalidgroupsearchbaseIT extends ArquillianBase {
    ...
    /**
     * Migrated from old-tck idstore/ldap/invalidgroupsearchbase.
     *
     * {@code groupSearchBase} doesn't exist. Search throws so we expect
     * "Exception received." (or VALID with empty groups on lenient
     * implementations).
     */
    @Test
