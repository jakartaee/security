...
/**
 * Configured with explicit {@code hashAlgorithmParameters}. These parameters
 * govern only generate-time behaviour; verify reads algorithm and parameters
 * back from the encoded hash, so verification succeeds for users with rows
