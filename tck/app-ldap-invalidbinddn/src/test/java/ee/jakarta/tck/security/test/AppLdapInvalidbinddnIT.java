...
public class AppLdapInvalidbinddnIT extends ArquillianBase {
    ...
    /**
     * Migrated from old-tck idstore/ldap/invalidbinddn.
     *
     * The {@code bindDn} points to a non-existing entry. Bind fails so the
     * IdentityStore throws and the HAM emits "Exception received." (or, on
     * implementations that map the bind failure to {@code INVALID}, an
     * INVALID result with no groups).
     */
    @Test
